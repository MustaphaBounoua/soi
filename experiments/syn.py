...
from src.benchmark.toy_dataset import Task_combination ,Task_synergy
...
def benchmark_exp(args):
    ...
    model = SOI(debias=False,
                        test_samples= test_samples,
                        gt = task.get_summary(),
                        lr=lr,
                        mod_list =mod_list ,
                        use_ema=True, 
                        batch_size = bs,debug=False,
                        margin_time= 1,
    ...
    CHECKPOINT_DIR = "trained_models/soi_{}/syn/seed_{}/setting{}/dim_{}/rho{}/".format(args.trans,args.seed,args.setting,args.dim,args.rho)
    ...
    model.eval()
    model.to("cuda")
    r[rho]  ["e"] = model.compute_o_inf_batch(test_loader, debias= True,nb_iter=10)
    return r
...
if __name__ =="__main__":
    ...
    path = "results/soi_{}/syn/seed_{}/setting_{}/dim_{}/".format(args.trans,args.seed,args.setting,args.dim)
